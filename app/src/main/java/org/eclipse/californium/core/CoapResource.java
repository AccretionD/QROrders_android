 ...
 * built up to a tree very easily, see {@link #add(org.eclipse.californium.core.CoapResource)}.
 * <p>
...
public  class CoapResource implements Resource {
	...
	/**
	 * Creates a {@link org.eclipse.californium.core.CoapClient} that uses the same executor as this resource
