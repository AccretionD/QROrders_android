...
import accretiond.android.chef.helper.LogcatHelper;
import accretiond.android.chef.helper.RuntimeHelper;
import accretiond.android.chef.helper.VersionHelper;
import accretiond.android.chef.util.UtilLogger;


public class SingleLogcatReader extends AbsLogcatReader {

	private static UtilLogger log = new UtilLogger(SingleLogcatReader.class.getSimpleName());
